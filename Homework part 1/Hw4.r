...
paste(data$student.name, first , weighted.mean(science.courses,science.weight), 
      second, weighted.mean(social.science,social.weight), third 
      , (weighted.mean(all.class,all.weight)), fourth, sd(all.class) )
